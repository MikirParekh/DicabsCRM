    ...
    child:ListView.builder(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoRow('Created On', item.creationDate),
                        _buildInfoRow('Sales Person', item.salesPerson),
                      ],
                    ),
                  ),
                );
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const MainPage(userCode: '', salesCode: '',)),
          );
        },
        backgroundColor: Colors.blue.shade700,
